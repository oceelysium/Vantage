...
export function Pick(props: Props) {
    ...
    return (
        <div
            ...
            classList={{
                "animate-slot-pulse border-l-2 border-l-secondary":
                    isSelected(),
            }}
        ...
        >
            ...
            <Show when={champion()}>
                <>
                    ...
                    <span class="absolute top-2 left-2 uppercase text-2xl leading-none text-white [text-shadow:0_1px_3px_rgba(0,0,0,0.75)]">
                        {championName(champion()!, config)}
                    </span>

                    <div
                        class="absolute bottom-0 left-0 right-0 flex justify-end overflow-x-auto pt-1 overflow-y-hidden text-white [text-shadow:0_1px_2px_rgba(0,0,0,0.7)]"
                        classList={{
