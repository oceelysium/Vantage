...
export function createDraftContext() {
    ...
    // Tab switches the active side (ally <-> opponent), jumping to that team's
    // next empty pick. Ignored while typing in a field.
    onMount(() => {
        const onKeyDown = (e: KeyboardEvent) => {
            ...
            e.preventDefault();
            const current = selection.team ?? "ally";
            select(current === "ally" ? "opponent" : "ally");
        };
